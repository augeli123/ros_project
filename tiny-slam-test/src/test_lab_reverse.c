...
//error: ‘TS_DISTANCE_NO_DETECTION’ undeclared 
...
typedef struct {
 ...
 //   error: conflicting types for ‘ts_sensor_data_t’
...
cart_sensor_data_t sensor_data[600];

int read_sensor_data(cart_sensor_data_t *data)
{   
    FILE *input;
